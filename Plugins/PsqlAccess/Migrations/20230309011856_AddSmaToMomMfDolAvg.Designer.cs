...
namespace PsqlAccess.Migrations
{
    ...
    [Migration("20230309011856_AddSmaToMomMfDolAvg")]
    partial class AddSmaToMomMfDolAvg
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationModels.Compute.MomMfDolAvg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("DollarVolume")
                        .HasColumnType("numeric");

                    b.Property<decimal>("Momentum")
                        .HasColumnType("numeric");

                    b.Property<decimal>("MoneyFlow")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("ApplicationModels.SimFin.SimFinRatio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<List<Indicator>>("Indicators")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("SimFinRatios");
                });

            modelBuilder.Entity("ApplicationModels.Views.SecurityWithPScore", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToView("SecurityWithPScores", (string)null);
                });
